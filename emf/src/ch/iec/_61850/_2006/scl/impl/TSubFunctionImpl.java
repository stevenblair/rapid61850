...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TSub Function</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link ch.iec._61850._2006.scl.impl.TSubFunctionImpl#getGeneralEquipment <em>General Equipment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TSubFunctionImpl extends TPowerSystemResourceImpl implements TSubFunction {
	/**
	...
	protected EClass eStaticClass() {
		return SclPackage.eINSTANCE.getTSubFunction();
	}
	...
	public EList<TGeneralEquipment> getGeneralEquipment() {
		if (generalEquipment == null) {
			generalEquipment = new EObjectContainmentEList<TGeneralEquipment>(TGeneralEquipment.class, this, SclPackage.TSUB_FUNCTION__GENERAL_EQUIPMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SclPackage.TSUB_FUNCTION__GENERAL_EQUIPMENT:
