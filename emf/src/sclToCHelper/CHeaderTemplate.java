...
public class CHeaderTemplate
{
  ...
  protected final String TEXT_3 = NL + NL + "#ifdef __cplusplus /* If this is a C++ compiler, use C linkage */" + NL + "extern \"C\" {" + NL + "#endif" + NL;
  ...
  protected final String TEXT_11 = NL + NL + "#ifdef __cplusplus /* If this is a C++ compiler, end C linkage */" + NL + "}" + NL + "#endif" + NL + "" + NL + "#endif";
