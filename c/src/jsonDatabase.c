...
void init_database() {
	...
	database.items[0].items[0].items[0].items[1].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[0].items[0].items[0].items[1].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[1].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[1].items[3].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[0].items[0].items[0].items[1].items[3].items[2].objectRef = "q";
	database.items[0].items[0].items[0].items[1].items[3].items[2].type = BASIC_TYPE_INT16U;
	database.items[0].items[0].items[0].items[1].items[3].items[2].data = &E1Q1SB1.S1.C1.exampleRMXU_1.AmpLocPhsA.q;
	...
	database.items[0].items[0].items[0].items[1].items[4].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[0].items[0].items[0].items[1].items[4].items[2].objectRef = "q";
	database.items[0].items[0].items[0].items[1].items[4].items[2].type = BASIC_TYPE_INT16U;
	database.items[0].items[0].items[0].items[1].items[4].items[2].data = &E1Q1SB1.S1.C1.exampleRMXU_1.AmpLocPhsB.q;
	...
	database.items[0].items[0].items[0].items[1].items[5].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[0].items[0].items[0].items[1].items[5].items[2].objectRef = "q";
	database.items[0].items[0].items[0].items[1].items[5].items[2].type = BASIC_TYPE_INT16U;
	database.items[0].items[0].items[0].items[1].items[5].items[2].data = &E1Q1SB1.S1.C1.exampleRMXU_1.AmpLocPhsC.q;
	...
	database.items[0].items[0].items[0].items[2].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[0].items[0].items[0].items[2].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[2].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[2].items[3].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[0].items[0].items[0].items[2].items[4].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[0].items[0].items[0].items[2].items[5].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[2].items[6].items = (Item*) malloc(sizeof(Item) * 3); // DAs
	...
	database.items[0].items[0].items[0].items[3].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[0].items[0].items[0].items[3].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[3].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[3].items[3].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[0].items[0].items[0].items[3].items[4].items = (Item*) malloc(sizeof(Item) * 3); // DAs
	...
	database.items[0].items[0].items[0].items[4].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[0].items[0].items[0].items[4].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[4].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[4].items[3].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[0].items[0].items[0].items[4].items[4].items = (Item*) malloc(sizeof(Item) * 3); // DAs
	...
	database.items[0].items[0].items[0].items[5].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[0].items[0].items[0].items[5].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[5].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[5].items[3].items = (Item*) malloc(sizeof(Item) * 7); // DAs
	...
	database.items[0].items[0].items[0].items[5].items[3].items[2].objectRef = "q";
	database.items[0].items[0].items[0].items[5].items[3].items[2].type = BASIC_TYPE_INT16U;
	database.items[0].items[0].items[0].items[5].items[3].items[2].data = &E1Q1SB1.S1.C1.MMXUa_1.Amps.q;
	database.items[0].items[0].items[0].items[5].items[3].items[3].objectRef = "t";
	database.items[0].items[0].items[0].items[5].items[3].items[3].type = BASIC_TYPE_INT24U;
	database.items[0].items[0].items[0].items[5].items[3].items[3].data = &E1Q1SB1.S1.C1.MMXUa_1.Amps.t;
	database.items[0].items[0].items[0].items[5].items[3].items[4].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	database.items[0].items[0].items[0].items[5].items[3].items[4].numberOfItems = 2;
	database.items[0].items[0].items[0].items[5].items[3].items[4].items[0].objectRef = "scaleFactor";
	database.items[0].items[0].items[0].items[5].items[3].items[4].items[0].type = BASIC_TYPE_FLOAT32;
	database.items[0].items[0].items[0].items[5].items[3].items[4].items[0].data = &E1Q1SB1.S1.C1.MMXUa_1.Amps.sVC.scaleFactor;
	database.items[0].items[0].items[0].items[5].items[3].items[4].items[1].objectRef = "offset";
	database.items[0].items[0].items[0].items[5].items[3].items[4].items[1].type = BASIC_TYPE_FLOAT32;
	database.items[0].items[0].items[0].items[5].items[3].items[4].items[1].data = &E1Q1SB1.S1.C1.MMXUa_1.Amps.sVC.offset;
	database.items[0].items[0].items[0].items[5].items[3].items[6].objectRef = "int1";
	database.items[0].items[0].items[0].items[5].items[3].items[6].type = BASIC_TYPE_INT32;
	database.items[0].items[0].items[0].items[5].items[3].items[6].data = &E1Q1SB1.S1.C1.MMXUa_1.Amps.int1;
	database.items[0].items[0].items[0].items[5].items[3].items[7].objectRef = "int2";
	database.items[0].items[0].items[0].items[5].items[3].items[7].type = BASIC_TYPE_INT32;
	database.items[0].items[0].items[0].items[5].items[3].items[7].data = &E1Q1SB1.S1.C1.MMXUa_1.Amps.int2;
	database.items[0].items[0].items[0].items[5].items[3].items[8].objectRef = "int3";
	database.items[0].items[0].items[0].items[5].items[3].items[8].type = BASIC_TYPE_INT32;
	database.items[0].items[0].items[0].items[5].items[3].items[8].data = &E1Q1SB1.S1.C1.MMXUa_1.Amps.int3;
	...
	database.items[0].items[0].items[0].items[5].items[4].items = (Item*) malloc(sizeof(Item) * 7); // DAs
	...
	database.items[0].items[0].items[0].items[5].items[4].items[2].objectRef = "q";
	database.items[0].items[0].items[0].items[5].items[4].items[2].type = BASIC_TYPE_INT16U;
	database.items[0].items[0].items[0].items[5].items[4].items[2].data = &E1Q1SB1.S1.C1.MMXUa_1.Volts.q;
	database.items[0].items[0].items[0].items[5].items[4].items[3].objectRef = "t";
	database.items[0].items[0].items[0].items[5].items[4].items[3].type = BASIC_TYPE_INT24U;
	database.items[0].items[0].items[0].items[5].items[4].items[3].data = &E1Q1SB1.S1.C1.MMXUa_1.Volts.t;
	database.items[0].items[0].items[0].items[5].items[4].items[4].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	database.items[0].items[0].items[0].items[5].items[4].items[4].numberOfItems = 2;
	database.items[0].items[0].items[0].items[5].items[4].items[4].items[0].objectRef = "scaleFactor";
	database.items[0].items[0].items[0].items[5].items[4].items[4].items[0].type = BASIC_TYPE_FLOAT32;
	database.items[0].items[0].items[0].items[5].items[4].items[4].items[0].data = &E1Q1SB1.S1.C1.MMXUa_1.Volts.sVC.scaleFactor;
	database.items[0].items[0].items[0].items[5].items[4].items[4].items[1].objectRef = "offset";
	database.items[0].items[0].items[0].items[5].items[4].items[4].items[1].type = BASIC_TYPE_FLOAT32;
	database.items[0].items[0].items[0].items[5].items[4].items[4].items[1].data = &E1Q1SB1.S1.C1.MMXUa_1.Volts.sVC.offset;
	database.items[0].items[0].items[0].items[5].items[4].items[6].objectRef = "int1";
	database.items[0].items[0].items[0].items[5].items[4].items[6].type = BASIC_TYPE_INT32;
	database.items[0].items[0].items[0].items[5].items[4].items[6].data = &E1Q1SB1.S1.C1.MMXUa_1.Volts.int1;
	database.items[0].items[0].items[0].items[5].items[4].items[7].objectRef = "int2";
	database.items[0].items[0].items[0].items[5].items[4].items[7].type = BASIC_TYPE_INT32;
	database.items[0].items[0].items[0].items[5].items[4].items[7].data = &E1Q1SB1.S1.C1.MMXUa_1.Volts.int2;
	database.items[0].items[0].items[0].items[5].items[4].items[8].objectRef = "int3";
	database.items[0].items[0].items[0].items[5].items[4].items[8].type = BASIC_TYPE_INT32;
	database.items[0].items[0].items[0].items[5].items[4].items[8].data = &E1Q1SB1.S1.C1.MMXUa_1.Volts.int3;
	...
	database.items[0].items[0].items[0].items[6].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[0].items[0].items[0].items[6].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[6].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[0].items[0].items[0].items[6].items[3].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[0].items[0].items[0].items[6].items[3].items[2].objectRef = "q";
	database.items[0].items[0].items[0].items[6].items[3].items[2].type = BASIC_TYPE_INT16U;
	database.items[0].items[0].items[0].items[6].items[3].items[2].data = &E1Q1SB1.S1.C1.TVTRa_1.Vol.q;
	...
	database.items[11].items[0].items[0].items[1].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[11].items[0].items[0].items[1].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[11].items[0].items[0].items[1].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[11].items[0].items[0].items[1].items[3].items = (Item*) malloc(sizeof(Item) * 3); // DAs
	database.items[11].items[0].items[0].items[1].items[3].numberOfItems = 3;
	database.items[11].items[0].items[0].items[1].items[3].items[0].objectRef = "A";
	...
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[0].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[0].items[2].numberOfItems = 1;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[0].items[2].items[0].objectRef = "f";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[0].items[2].items[0].type = BASIC_TYPE_FLOAT32;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[0].items[2].items[0].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA.cVal.ang.f;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[2].objectRef = "q";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[2].type = BASIC_TYPE_INT16U;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[2].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA.q;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[3].objectRef = "t";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[3].type = BASIC_TYPE_INT24U;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[3].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA.t;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[4].objectRef = "testInteger";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[4].type = BASIC_TYPE_INT32;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[4].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA.testInteger;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].objectRef = "testBoolean";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].type = BASIC_TYPE_BOOLEAN;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA.testBoolean;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].objectRef = "phsA";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].type = BASIC_TYPE_COMPOUND;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items = (Item*) malloc(sizeof(Item) * 3); // DAs within SDO
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].numberOfItems = 3;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[0].objectRef = "stVal";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[0].type = BASIC_TYPE_INT32;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[0].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA.testSecondLayerSDO.stVal;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[1].objectRef = "q";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[1].type = BASIC_TYPE_INT16U;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[1].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA.testSecondLayerSDO.q;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[2].objectRef = "t";
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[2].type = BASIC_TYPE_INT24U;
	database.items[11].items[0].items[0].items[1].items[3].items[1].items[5].items[2].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsA.testSecondLayerSDO.t;
	database.items[11].items[0].items[0].items[1].items[3].items[1].objectRef = "A";
	...
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[0].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[0].items[2].numberOfItems = 1;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[0].items[2].items[0].objectRef = "f";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[0].items[2].items[0].type = BASIC_TYPE_FLOAT32;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[0].items[2].items[0].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB.cVal.ang.f;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[2].objectRef = "q";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[2].type = BASIC_TYPE_INT16U;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[2].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB.q;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[3].objectRef = "t";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[3].type = BASIC_TYPE_INT24U;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[3].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB.t;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[4].objectRef = "testInteger";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[4].type = BASIC_TYPE_INT32;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[4].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB.testInteger;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].objectRef = "testBoolean";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].type = BASIC_TYPE_BOOLEAN;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB.testBoolean;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].objectRef = "phsB";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].type = BASIC_TYPE_COMPOUND;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items = (Item*) malloc(sizeof(Item) * 3); // DAs within SDO
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].numberOfItems = 3;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[0].objectRef = "stVal";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[0].type = BASIC_TYPE_INT32;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[0].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB.testSecondLayerSDO.stVal;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[1].objectRef = "q";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[1].type = BASIC_TYPE_INT16U;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[1].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB.testSecondLayerSDO.q;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[2].objectRef = "t";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[2].type = BASIC_TYPE_INT24U;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[2].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsB.testSecondLayerSDO.t;
	database.items[11].items[0].items[0].items[1].items[3].items[2].objectRef = "A";
	...
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[0].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[2].objectRef = "q";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[2].type = BASIC_TYPE_INT16U;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[2].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsC.q;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[3].objectRef = "t";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[3].type = BASIC_TYPE_INT24U;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[3].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsC.t;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[4].objectRef = "testInteger";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[4].type = BASIC_TYPE_INT32;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[4].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsC.testInteger;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].objectRef = "testBoolean";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].type = BASIC_TYPE_BOOLEAN;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsC.testBoolean;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].objectRef = "phsC";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].type = BASIC_TYPE_COMPOUND;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsC;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items = (Item*) malloc(sizeof(Item) * 3); // DAs within SDO
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].numberOfItems = 3;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[0].objectRef = "stVal";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[0].type = BASIC_TYPE_INT32;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[0].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsC.testSecondLayerSDO.stVal;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[1].objectRef = "q";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[1].type = BASIC_TYPE_INT16U;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[1].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsC.testSecondLayerSDO.q;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[2].objectRef = "t";
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[2].type = BASIC_TYPE_INT24U;
	database.items[11].items[0].items[0].items[1].items[3].items[2].items[5].items[2].data = &D1Q1SB4.S1.C1.exampleMMXU_1.A.phsC.testSecondLayerSDO.t;
	...
	database.items[11].items[0].items[0].items[2].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[11].items[0].items[0].items[2].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[11].items[0].items[0].items[2].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[11].items[0].items[0].items[2].items[3].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[11].items[0].items[0].items[2].items[4].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[11].items[0].items[0].items[2].items[5].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[11].items[0].items[0].items[2].items[6].items = (Item*) malloc(sizeof(Item) * 3); // DAs
	...
	database.items[11].items[0].items[0].items[3].items[0].items = (Item*) malloc(sizeof(Item) * 4); // DAs
	...
	database.items[11].items[0].items[0].items[3].items[1].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[11].items[0].items[0].items[3].items[2].items = (Item*) malloc(sizeof(Item) * 1); // DAs
	...
	database.items[11].items[0].items[0].items[3].items[3].items = (Item*) malloc(sizeof(Item) * 2); // DAs
	...
	database.items[11].items[0].items[0].items[3].items[4].items = (Item*) malloc(sizeof(Item) * 3); // DAs
